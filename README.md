...
- Exemplo_Prático_02 - Construção de um código para pegar todos os títulos, quantidade em estoque e valores das páginas do (https://books.toscrape.com/index.html) - [Link](url)
- Exemplo_Prático_03 -
- Exemplo_Prático_04 -
- Exemplo_Prático_05 -
